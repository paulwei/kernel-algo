...
public class 山脉数组中查找目标值 {
    ...
    private static int findMountaintop(MountainArray mountainArr, int l, int r) {
        // 返回山顶元素
        while (l < r) {
            int mid = l + (r - l) / 2;
    ...
    private static int findFromSortedArr(MountainArray mountainArr, int l, int r, int target) {
    ...
    private static int findFromInversedArr(MountainArray mountainArr, int l, int r, int target) {
