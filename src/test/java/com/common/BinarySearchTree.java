...
public class BinarySearchTree<AnyType extends Comparable<? super AnyType>> {
    ...
    private static class BinaryNode<AnyType> {
        ...
        BinaryNode<AnyType> left; // 节点左孩子
        BinaryNode<AnyType> right; // 节点右孩子
        ...
        public BinaryNode(final AnyType element, final BinaryNode<AnyType> left, final BinaryNode<AnyType> right) {
